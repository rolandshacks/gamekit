...
impl Constants {
    ...
    pub const REQUIRE_VULKAN_12_FEATURES: bool = true; // enable API 1.2 features
    pub const REQUIRE_SCALAR_BLOCK_LAYOUT_FEATURE: bool = true; // scalar layout for shaders (API 1.2)
