...
pub fn required_sdl_instance_extension_names(sdl_window: &sdl2::video::Window) -> Vec<&'static str> {
    sdl_window.vulkan_instance_extensions().unwrap()
}
...
pub const LAYER_KHRONOS_VALIDATION_NAME: &CStr = c"VK_LAYER_KHRONOS_validation" ;
pub const LAYER_LUNAR_API_DUMP_NAME: &CStr = c"VK_LAYER_LUNARG_api_dump" ;
