...
impl DeviceFeatures {
    ...
    pub fn has_scalar_block_layout(&self) -> bool {
...
impl Device {
    ...
    fn create_physical_device(
        ...
        'device_loop: for physical_device in devices {
            ...
            let surface_format = surface_formats[found_swap_space_surface_format as usize];
    ...
    fn create_logical_device(instance: &Instance, physical_device_info: &PhysicalDeviceInfo) -> Result<LogicalDeviceInfo, Error>{
        ...
        let mut features_vulkan_12 = vk::PhysicalDeviceVulkan12Features::default();
        ...
        if Constants::REQUIRE_VULKAN_12_FEATURES {
            if Constants::REQUIRE_EXTENDED_DYNAMIC_STATE3 {
                feature_info_dynamic_state3.p_next = &mut features_vulkan_12 as *mut _ as *mut core::ffi::c_void;
            } else {
                feature_info_dynamic_state.p_next = &mut features_vulkan_12 as *mut _ as *mut core::ffi::c_void;
            }

            if Constants::REQUIRE_SCALAR_BLOCK_LAYOUT_FEATURE {
                features_vulkan_12.scalar_block_layout = vk::TRUE;
                device_features.scalar_block_layout = true;
            }
        }
