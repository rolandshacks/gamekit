...
impl ApplicationData {
    pub fn new() -> Self {
        ...
        let shader_params = Uniform::<ShaderParams>::new(0, 1).unwrap();
        ...
        let tilemap = {
            ...
            let cols = (metrics.width as usize + 7) / 8 + tiles_per_row + 1;
...
impl Application for App {
    ...
    fn on_update(&mut self) {
        ...
        { // set background position
            ...
            appdata.background.set_size(metrics.width, metrics.height);
        }
        ...
        { // do scrolling
            ...
            if appdata.tilemap_scroll.x < -(appdata.tilemap_width as f32 + metrics.width) {
...

        {
            ...
            params.view_left = metrics.view_left;
            params.view_top = metrics.view_top;
    ...
    fn on_draw(&mut self) {
        ...
        {
            renderer.set_scissor(metrics.view_left + 8.0 * metrics.scaling, metrics.view_top, metrics.view_width - 16.0 * metrics.scaling, metrics.view_height);
            ...
            params.offset_top = metrics.height - appdata.tilemap_height as f32;
