...
impl Entity {
    ...
    pub fn initialize(&mut self, _frame: usize, metrics: &Metrics) {
        ...
        let x = api::Random::get_float_range(0.0, metrics.window_width);
        let y = api::Random::get_float_range(0.0, metrics.window_height);
    ...
    pub fn update(&mut self, delta_time: f32, metrics: &Metrics) {
        ...
        let min_x = 0.0f32;
        let max_x = (metrics.view_width) - self.size.x;
        let min_y = 0.0f32;
        let max_y = (metrics.view_height) - self.size.y;
