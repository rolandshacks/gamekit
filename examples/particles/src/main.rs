...
impl ApplicationData {
    pub fn new() -> Self {
        ...
        let push_params = PushConstants::<PushParams>::new().unwrap();
        let shader_params = Uniform::<ShaderParams>::new(0, 0).unwrap();
...
impl Application for App {
    ...
    fn on_update(&mut self) {
...

        {
            ...
            params.resolution_x = self.screen_size.x;
            params.resolution_y = self.screen_size.y;
            params.x_min = 0.0;
            params.y_min = 0.0;
            params.x_max = self.screen_size.x;
            params.y_max = self.screen_size.y;
            params.time = tm.time;
