...
void main() {
    ...
    float x = -1.0 + 2.0 * (push.offset_x + params.view_x + iPosition.x * params.view_scaling) / window_width;
    float y = -1.0 + 2.0 * (push.offset_y + params.view_y + iPosition.y * params.view_scaling) / window_height;
